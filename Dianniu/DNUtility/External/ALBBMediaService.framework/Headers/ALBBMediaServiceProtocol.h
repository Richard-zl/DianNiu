 ...
 *
 * @param tokenDelegate 上传token的生成器。需要自定义上传token的需要实现TFETokenGenerator的protocol
 */
 ...
 *  取消特定任务
 *
 *  @param uniqueIdentifier    本地上传id，用于标识本地一个任务， 使用TaeFile.localUniqueIdentifier, 或者使用upload的返回参数
 */
