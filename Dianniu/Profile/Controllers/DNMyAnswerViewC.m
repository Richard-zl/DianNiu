...
- (void)configTableView{
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"DNMyAnswerCell" bundle:nil] forCellReuseIdentifier:@"DNMyAnswerCell"];
...
- (void)myQuestingRequest:(BOOL)isPull{
    DNMyAnswersRequest *request = [[DNMyAnswersRequest alloc] init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    DNMyAnswerCell *cell = [tableView dequeueReusableCellWithIdentifier:@"DNMyAnswerCell" forIndexPath:indexPath];
