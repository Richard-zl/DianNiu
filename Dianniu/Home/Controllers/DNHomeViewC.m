...
#warning 跳转到权限认证页面
        ...
        DNAskquestionViewC *askViewC = [[DNAskquestionViewC alloc] initWithNibName:@"DNAskquestionViewC" bundle:nil];
        askViewC.type = type;
        [self.navigationController pushViewController:askViewC animated:YES];
    }];
