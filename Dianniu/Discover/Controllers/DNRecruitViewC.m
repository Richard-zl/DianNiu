...
@interface DNRecruitViewC ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic, strong)UITableView *tableView;
@property (nonatomic, strong)NSMutableArray *dataSource;
@property (nonatomic, copy) NSString *currentPostStr;
@property (nonatomic, strong)DNRecruitListRequest *lastRequest;
@end

@implementation DNRecruitViewC
...
- (void)requestJobList:(NSString *)postStr Refresh:(BOOL)isRefresh{
    ...
    DNRecruitListRequest *request= [[DNRecruitListRequest alloc] init];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    detailC.type = DNRecruitDetailType_RECRUIT;
